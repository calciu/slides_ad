...
L'association des Žtudiants d'une universitŽ envisage d'ouvrir un cinŽ-club; afin d'en Žvaluer la frŽquentation, elle a rŽalisŽ une enqute par sondage sur un Žchantillon de 1000 individus. Une moyenne de frŽquentation de 10 sŽances par an et par individu a ŽtŽ obtenue avec un Žcart type s = 20. Le nombre rŽel de frŽquentations (ˆ un seuil de confiance de 95%) oscilera autour de 10 avec + ou - : {#1.239613:0.01}
//z=1.96;n=1000;s=20;z*s/sqrt(n) 

L'association des Žtudiants d'une universitŽ envisage d'ouvrir un cinŽ-club; afin d'en Žvaluer la frŽquentation, elle a rŽalisŽ une enqute par sondage sur un Žchantillon de 500 individus. Une moyenne de frŽquentation de 20 sŽances par an et par individu a ŽtŽ obtenue avec un Žcart type s = 30. Le nombre rŽel de frŽquentations (ˆ un seuil de confiance de 95%) oscilera autour de 20 avec + ou - : {#2.629616:0.01}
//z=1.96;n=500;s=30;z*s/sqrt(n) 


L'association des Žtudiants d'une universitŽ de 2000 Žtudiants envisage d'ouvrir un cinŽ-club; afin d'en Žvaluer la frŽquentation, elle a rŽalisŽ une enqute par sondage sur un Žchantillon de 1000 individus. Une moyenne de frŽquentation de 10 sŽances par an et par individu a ŽtŽ obtenue avec un Žcart type s = 20. Le nombre rŽel de frŽquentations (ˆ un seuil de confiance de 95%) oscilera autour de 10 avec + ou - : {#0.8767579:0.01}
//z=1.96;s=20;n=1000;N=2000;z*s/sqrt(n)*sqrt((N-n)/(N-1))


L'association des Žtudiants d'une universitŽ 2000 Žtudiants envisage d'ouvrir un cinŽ-club; afin d'en Žvaluer la frŽquentation, elle a rŽalisŽ une enqute par sondage sur un Žchantillon de 500 individus. Une moyenne de frŽquentation de 20 sŽances par an et par individu a ŽtŽ obtenue avec un Žcart type s = 30. Le nombre rŽel de frŽquentations (ˆ un seuil de confiance de 95%) oscilera autour de 20 avec + ou - : {#2.277884:0.01}
//z=1.96;s=30;n=500;N=2000;z*s/sqrt(n)*sqrt((N-n)/(N-1))


L'association des Žtudiants d'une universitŽ envisage d'ouvrir un cinŽ-club; afin d'en Žvaluer la frŽquentation, elle a rŽalisŽ une enqute par sondage sur un Žchantillon de 21 individus. Une moyenne de frŽquentation de 15 sŽances par an et par individu suit une loi de Student ˆ 20 degrŽs de libertŽ, avec un Žcart type s = 20. Le nombre rŽel de frŽquentations (ˆ un seuil de confiance de 95%) oscilera autour de 15 avec + ou - : {#9.10389:0.01}
//qt(.975,20)*20/sqrt(21) 



Dans le cadre d'une Žtude de notoriŽtŽ, 25 % des personnes interrogŽes ont dŽclarŽ conna”tre la marque M. Un Žchantillon alŽatoire non exhaustif de 1000 individus a ŽtŽ utilisŽ. Dans une approche pessimiste la vraie proportion (ˆ un seuil de confiance de 95%) oscilera autour de 25% avec + ou - : {#0.01581139:001}
// n=1000;sqrt((0.5*(1-0.5))/n)

Dans le cadre d'une Žtude de notoriŽtŽ, 25 % des personnes interrogŽes ont dŽclarŽ conna”tre la marque M. Un Žchantillon alŽatoire non exhaustif de 1000 individus a ŽtŽ utilisŽ. Dans une approche optimiste la vraie proportion (ˆ un seuil de confiance de 95%) oscilera autour de 25% avec + ou - : {#0.01369306:001}
// n=1000;p=.25;sqrt((p*(1-p))/n)


Dans le cadre d'une Žtude de notoriŽtŽ, 25 % des personnes interrogŽes ont dŽclarŽ conna”tre la marque M. Un Žchantillon alŽatoire non exhaustif de 1000 individus a ŽtŽ utilisŽ. Quelle est la diffŽrence de prŽcision entre l'approche pessimiste et optimiste (ˆ un seuil de confiance de 95%) de cette estimation: {#0.002118324:0001}
// n=1000;p=.25;sqrt(0.5*(1-0.5)/n)-sqrt((p*(1-p))/n)

Le seuil de rentabilitŽ d'un produit industriel nouveau s'Žlve ˆ 50 unitŽs vendues par consomateur. Sur un Žchantillon de 100 consommateurs, une intention d'achat moyenne de 62 a ŽtŽ repŽrŽe, avec un Žcart-type de 60.Quel type de test d'hypothse est applicables ici:{~unilatŽral gauche, ~bilatŽral, =unilatŽral droit}

Le seuil de rentabilitŽ d'un produit industriel nouveau s'Žlve ˆ 50 unitŽs vendues par consomateur. Sur un Žchantillon de 100 consommateurs, une intention d'achat moyenne de 62 a ŽtŽ repŽrŽe, avec un Žcart-type de 60. Est-ce que le risque de tomber en desous du seuil de rentabilitŽ peut tre rejetŽ avec un seuil de risque de 2.5% ?{=Oui,~non}
//n=100;xs=50;xm=62;s=60;(xm - xs)/s*sqrt(n) > qnorm(.975, 0,1)

Le seuil de rentabilitŽ d'un produit industriel nouveau s'Žlve ˆ 50 unitŽs vendues par consomateur. Sur un Žchantillon de 100 consommateurs, une intention d'achat moyenne de 62 a ŽtŽ repŽrŽe, avec un Žcart-type de 60. Est-ce que le risque de tomber en desous du seuil de rentabilitŽ peut tre rejetŽ avec un seuil de risque de 5% ?{=Oui,~non}
//xs=50;xm=62;s=60;(xm - xs)/s*sqrt(n) > qnorm(.95, 0,1)

Le seuil de rentabilitŽ d'un produit industriel nouveau s'Žlve ˆ 50 unitŽs vendues par consomateur. Sur un Žchantillon de 100 consommateurs, une intention d'achat moyenne de 62 a ŽtŽ repŽrŽe, avec un Žcart-type de 60. Quel est le risque de se trouver sous le seuil de rentabilitŽ (avec une prŽcision de 0.001) ? {#0.02275013:0.001}
//n=100;xs=50;xm=62;s=60;1-pnorm((xm - xs)/s*sqrt(n))


Le seuil de rentabilitŽ d'un produit industriel nouveau s'Žlve ˆ 50 unitŽs vendues par consomateur. Sur un Žchantillon de 100 consommateurs, une intention d'achat moyenne de 56 a ŽtŽ repŽrŽe, avec un Žcart-type de 60.Quel type de test d'hypothse est applicables ici:{~unilatŽral gauche, ~bilatŽral, =unilatŽral droit}

Le seuil de rentabilitŽ d'un produit industriel nouveau s'Žlve ˆ 50 unitŽs vendues par consomateur. Sur un Žchantillon de 100 consommateurs, une intention d'achat moyenne de 56 a ŽtŽ repŽrŽe, avec un Žcart-type de 60. Est-ce que le risque de tomber en desous du seuil de rentabilitŽ peut tre rejetŽ avec un seuil de risque de 2.5% ?{~Oui,=Non}
//n=100;xs=50;xm=56;s=60;(xm - xs)/s*sqrt(n) > qnorm(.975, 0,1)

Le seuil de rentabilitŽ d'un produit industriel nouveau s'Žlve ˆ 50 unitŽs vendues par consomateur. Sur un Žchantillon de 100 consommateurs, une intention d'achat moyenne de 56 a ŽtŽ repŽrŽe, avec un Žcart-type de 60. Est-ce que le risque de tomber en desous du seuil de rentabilitŽ peut tre rejetŽ avec un seuil de risque de 5% ?{~Oui,=Non}
//n=100;xs=50;xm=56;s=60;(xm - xs)/s*sqrt(n) > qnorm(.95, 0,1)

Le seuil de rentabilitŽ d'un produit industriel nouveau s'Žlve ˆ 50 unitŽs vendues par consomateur. Sur un Žchantillon de 100 consommateurs, une intention d'achat moyenne de 56 a ŽtŽ repŽrŽe, avec un Žcart-type de 60. Quel est le risque de se trouver sous le seuil de rentabilitŽ (prŽcision 0.001)? {#0.1586553:0.001}
//n=100;xs=50;xm=56;s=60;1-pnorm((xm - xs)/s*sqrt(n))

Le taux de notoriŽtŽ de la marque M mesurŽ sur un Žchantillon de 1000 consommateurs ˆ la suite d'une campagne publicitaire Žtait de 25%. Le taux de notoriŽtŽ prŽcŽdemment connu s'Žlevait ˆ 21%. Peut-on en conclure que la publicitŽ a fait augmenter de faÃ§on significative la connaissance de la marque ? {=Oui,~Non}
//n=1000;ps=0.21;p=0.25;(p-ps)/sqrt(.5*(1-.5)/n) > qnorm(.975)

Le taux de notoriŽtŽ de la marque M mesurŽ sur un Žchantillon de 1000 consommateurs ˆ la suite d'une campagne publicitaire Žtait de 25%. Le taux de notoriŽtŽ prŽcŽdemment connu s'Žlevait ˆ 21%. Quel est le risque que la campagne n'ait pas eu d'effet sur la notoriŽtŽ? (prŽcision 0.0001){#0.005706018:0.001}
...
Calculez l'intervalle de confiance positif (alternative pessimiste) de la proportion des gens qui sont d'accord avec l'affirmation: CAMIP vend une ligne de produits de haute qualitŽ' {#0.0880066:0.001} 
...
Calculez l'intervalle de confiance positif (alternative pessimiste) de la proportion des gens qui sont d'accord avec l'affirmation: CAMIP a un catalogue de trs haute qualitŽ' {#0.0880066:0.001} 
//x=V18[which(V18!=0)];n=length(x);1.96*sqrt(.5*(1-.5)/n)

Calculez l'intervalle de confiance positif (alternative pessimiste) de la proportion des gens qui sont d'accord avec l'affirmation: La description des produits dans le catalogue CAMIP est trs prŽcise' {#0.0880066:0.001} 
//x=V19[which(V19!=0)];n=length(x);1.96*sqrt(.5*(1-.5)/n)

Calculez l'intervalle de confiance positif (alternative pessimiste) de la proportion des gens qui sont d'accord avec l'affirmation: La sŽlection de produits dans le catalogue CAMIP est trs large' {#0.0880066:0.001} 
//x=V20[which(V20!=0)];n=length(x);1.96*sqrt(.5*(1-.5)/n)

Calculez l'intervalle de confiance positif (alternative pessimiste) de la proportion des gens qui sont d'accord avec l'affirmation: "ProbabilitŽ rŽduite que la marchandise soie perdue pendant l'envoie" {#0.09099072:0.001} 
//x=V21[which(V21!=0)];n=length(x);1.96*sqrt(.5*(1-.5)/n)

Calculez l'intervalle de confiance positif (alternative pessimiste) de la proportion des gens qui sont d'accord avec l'affirmation: "Pas besoin de ce consulter avec quelqu'un qui a dŽjˆ achetŽ" {#0.09021631:0.001} 
...
Calculez l'intervalle de confiance positif (alternative pessimiste) de la proportion des gens qui sont d'accord avec l'affirmation: "L'achat par catalogue Žconomise du temps" {#0.08836362:0.001} 
//x=V24[which(V24!=0)];n=length(x);1.96*sqrt(.5*(1-.5)/n)

Calculez l'intervalle de confiance positif (alternative pessimiste) de la proportion des gens qui sont d'accord avec l'affirmation: Pas difficile de nŽgocier le prix' {#0.08836362:0.001} 
...
Calculez l'intervalle de confiance positif (alternative pessimiste) de la proportion des gens qui donnent de l'importance ˆ: PossibilitŽ de placer un nombre illimitŽ de commandes' {#0.08983645:0.001} 
//x=V30[which(V30!=0)];n=length(x);1.96*sqrt(.5*(1-.5)/n)

Calculez l'intervalle de confiance positif (alternative pessimiste) de la proportion des gens qui donnent de l'importance ˆ: DisponibilitŽ de discounts pour la quantitŽ achetŽe' {#0.09301748:0.001} 
//x=V31[which(V31!=0)];n=length(x);1.96*sqrt(.5*(1-.5)/n)

Calculez l'intervalle de confiance positif (alternative pessimiste) de la proportion des gens qui donnent de l'importance ˆ: DurŽe de la livraison' {#0.09021631:0.001} 
//x=V32[which(V32!=0)];n=length(x);1.96*sqrt(.5*(1-.5)/n)

Calculez l'intervalle de confiance positif (alternative pessimiste) de la proportion des gens qui donnent de l'importance ˆ: Politique de la sociŽtŽ visant le retour de la marchandise' {#0.09386698:0.001} 
//x=V33[which(V33!=0)];n=length(x);1.96*sqrt(.5*(1-.5)/n)

Calculez l'intervalle de confiance positif (alternative pessimiste) de la proportion des gens qui donnent de l'importance ˆ: "PrŽvision d'une pŽriode d'essai" {#0.08946135:0.001} 
//x=V34[which(V34!=0)];n=length(x);1.96*sqrt(.5*(1-.5)/n)

Calculez l'intervalle de confiance positif (alternative pessimiste) de la proportion des gens qui donnent de l'importance ˆ: AnnŽes de prŽsence de la sociŽtŽ sur le marche' {#0.0926013:0.001} 
//x=V35[which(V35!=0)];n=length(x);1.96*sqrt(.5*(1-.5)/n)

Calculez l'intervalle de confiance positif (alternative pessimiste) de la proportion des gens qui donnent de l'importance ˆ: RŽputation de la sociŽtŽ' {#0.08983645:0.001} 
//x=V36[which(V36!=0)];n=length(x);1.96*sqrt(.5*(1-.5)/n)

Calculez l'intervalle de confiance positif (alternative pessimiste) de la proportion des gens qui donnent de l'importance ˆ: Garanties' {#0.09301748:0.001} 
//x=V37[which(V37!=0)];n=length(x);1.96*sqrt(.5*(1-.5)/n)

Calculez l'intervalle de confiance positif (alternative pessimiste) de la proportion des gens qui donnent de l'importance ˆ: Contacte de la sociŽtŽ avec les grandes marques etc.' {#0.09138547:0.001} 
...
Calculez l'intervalle de confiance positif (alternative optimiste) de la proportion des gens qui sont d'accord avec l'affirmation: CAMIP vend une ligne de produits de haute qualitŽ' {#0.08573358:0.001} 
...
Calculez l'intervalle de confiance positif (alternative optimiste) de la proportion des gens qui sont d'accord avec l'affirmation: CAMIP a un catalogue de trs haute qualitŽ' {#0.08744388:0.001} 
//x=V18[which(V18!=0)];n=length(x);n2=length(x[x>3]);p=n2/n;1.96*sqrt(p*(1-p)/n)

Calculez l'intervalle de confiance positif (alternative optimiste) de la proportion des gens qui sont d'accord avec l'affirmation: La description des produits dans le catalogue CAMIP est trs prŽcise' {#0.08771995:0.001} 
//x=V19[which(V19!=0)];n=length(x);n2=length(x[x>3]);p=n2/n;1.96*sqrt(p*(1-p)/n)

Calculez l'intervalle de confiance positif (alternative optimiste) de la proportion des gens qui sont d'accord avec l'affirmation: La sŽlection de produits dans le catalogue CAMIP est trs large' {#0.08707443:0.001} 
//x=V20[which(V20!=0)];n=length(x);n2=length(x[x>3]);p=n2/n;1.96*sqrt(p*(1-p)/n)

Calculez l'intervalle de confiance positif (alternative optimiste) de la proportion des gens qui sont d'accord avec l'affirmation: "ProbabilitŽ rŽduite que la marchandise soie perdue pendant l'envoie" {#0.08988858:0.001} 
//x=V21[which(V21!=0)];n=length(x);n2=length(x[x>3]);p=n2/n;1.96*sqrt(p*(1-p)/n)

Calculez l'intervalle de confiance positif (alternative optimiste) de la proportion des gens qui sont d'accord avec l'affirmation: "Pas besoin de ce consulter avec quelqu'un qui a dŽjˆ achetŽ" {#0.08891103:0.001} 
...
Calculez l'intervalle de confiance positif (alternative optimiste) de la proportion des gens qui sont d'accord avec l'affirmation: "L'achat par catalogue Žconomise du temps" {#0.07111831:0.001} 
//x=V24[which(V24!=0)];n=length(x);n2=length(x[x>3]);p=n2/n;1.96*sqrt(p*(1-p)/n)

Calculez l'intervalle de confiance positif (alternative optimiste) de la proportion des gens qui sont d'accord avec l'affirmation: Pas difficile de nŽgocier le prix' {#0.08104916:0.001} 
...
Calculez l'intervalle de confiance positif (alternative optimiste) de la proportion des gens qui donnent de l'importance ˆ: PossibilitŽ de placer un nombre illimitŽ de commandes' {#0.0896809:0.001} 
//x=V30[which(V30!=0)];n=length(x);n2=length(x[x>3]);p=n2/n;1.96*sqrt(p*(1-p)/n)

Calculez l'intervalle de confiance positif (alternative optimiste) de la proportion des gens qui donnent de l'importance ˆ: DisponibilitŽ de discounts pour la quantitŽ achetŽe' {#0.08827238:0.001} 
//x=V31[which(V31!=0)];n=length(x);n2=length(x[x>3]);p=n2/n;1.96*sqrt(p*(1-p)/n)

Calculez l'intervalle de confiance positif (alternative optimiste) de la proportion des gens qui donnent de l'importance ˆ: DurŽe de la livraison' {#0.08891103:0.001} 
//x=V32[which(V32!=0)];n=length(x);n2=length(x[x>3]);p=n2/n;1.96*sqrt(p*(1-p)/n)

Calculez l'intervalle de confiance positif (alternative optimiste) de la proportion des gens qui donnent de l'importance ˆ: Politique de la sociŽtŽ visant le retour de la marchandise' {#0.07892707:0.001} 
//x=V33[which(V33!=0)];n=length(x);n2=length(x[x>3]);p=n2/n;1.96*sqrt(p*(1-p)/n)

Calculez l'intervalle de confiance positif (alternative optimiste) de la proportion des gens qui donnent de l'importance ˆ: "PrŽvision d'une pŽriode d'essai" {#0.08132568:0.001} 
//x=V34[which(V34!=0)];n=length(x);n2=length(x[x>3]);p=n2/n;1.96*sqrt(p*(1-p)/n)

Calculez l'intervalle de confiance positif (alternative optimiste) de la proportion des gens qui donnent de l'importance ˆ: AnnŽes de prŽsence de la sociŽtŽ sur le marche' {#0.08443054:0.001} 
//x=V35[which(V35!=0)];n=length(x);n2=length(x[x>3]);p=n2/n;1.96*sqrt(p*(1-p)/n)

Calculez l'intervalle de confiance positif (alternative optimiste) de la proportion des gens qui donnent de l'importance ˆ: RŽputation de la sociŽtŽ' {#0.0896809:0.001} 
//x=V36[which(V36!=0)];n=length(x);n2=length(x[x>3]);p=n2/n;1.96*sqrt(p*(1-p)/n)

Calculez l'intervalle de confiance positif (alternative optimiste) de la proportion des gens qui donnent de l'importance ˆ: Garanties' {#0.08643953:0.001} 
//x=V37[which(V37!=0)];n=length(x);n2=length(x[x>3]);p=n2/n;1.96*sqrt(p*(1-p)/n)

Calculez l'intervalle de confiance positif (alternative optimiste) de la proportion des gens qui donnent de l'importance ˆ: Contacte de la sociŽtŽ avec les grandes marques etc.' {#0.02389261:0.001} 
