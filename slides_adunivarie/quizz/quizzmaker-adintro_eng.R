...
enonce=c("L'association des étudiants d'une université envisage d'ouvrir un ciné-club; afin d'en évaluer la fréquentation, elle a réalisé une enquête par sondage sur un échantillon de",n,"individus. Une moyenne de fréquentation de",m,"séances par an et par individu a été obtenue avec un écart type s =",s,". Le nombre réel de fréquentations (à un seuil de confiance de",100*conf,"%) oscilera autour de 10 avec + ou - : {#",z*s/sqrt(n),"}")
cat(enonce,"\n//z=qnorm(",conf+(1-conf)/2,");n=",n,";s=",s,";z*s/sqrt(n)\n\n") 

L'association des <8e>tudiants d'une universit<8e> envisage d'ouvrir un cin<8e>-club; afin d'en <8e>valuer la fr<8e>quentation, elle a r<8e>alis<8e> une enqu<90>te par sondage sur un <8e>chantillon de 500 individus. Une moyenne de fr<8e>quentation de 20 s<8e>ances par an et par individu a <8e>t<8e> obtenue avec un <8e>cart type s = 30. Le nombre r<8e>el de fr<8e>quentations (<88> un seuil de confiance de 95%) oscilera autour de 20 avec + ou - : {#2.629616:0.01}
//z=1.96;n=500;s=30;z*s/sqrt(n) 


L'association des <8e>tudiants d'une universit<8e> de 2000 <8e>tudiants envisage d'ouvrir un cin<8e>-club; afin d'en <8e>valuer la fr<8e>quentation, elle a r<8e>alis<8e> une enqu<90>te par sondage sur un <8e>chantillon de 1000 individus. Une moyenne de fr<8e>quentation de 10 s<8e>ances par an et par individu a <8e>t<8e> obtenue avec un <8e>cart type s = 20. Le nombre r<8e>el de fr<8e>quentations (<88> un seuil de confiance de 95%) oscilera autour de 10 avec + ou - : {#0.8767579:0.01}
//z=1.96;s=20;n=1000;N=2000;z*s/sqrt(n)*sqrt((N-n)/(N-1))


L'association des <8e>tudiants d'une universit<8e> 2000 <8e>tudiants envisage d'ouvrir un cin<8e>-club; afin d'en <8e>valuer la fr<8e>quentation, elle a r<8e>alis<8e> une enqu<90>te par sondage sur un <8e>chantillon de 500 individus. Une moyenne de fr<8e>quentation de 20 s<8e>ances par an et par individu a <8e>t<8e> obtenue avec un <8e>cart type s = 30. Le nombre r<8e>el de fr<8e>quentations (<88> un seuil de confiance de 95%) oscilera autour de 20 avec + ou - : {#2.277884:0.01}
//z=1.96;s=30;n=500;N=2000;z*s/sqrt(n)*sqrt((N-n)/(N-1))


L'association des <8e>tudiants d'une universit<8e> envisage d'ouvrir un cin<8e>-club; afin d'en <8e>valuer la fr<8e>quentation, elle a r<8e>alis<8e> une enqu<90>te par sondage sur un <8e>chantillon de 21 individus. Une moyenne de fr<8e>quentation de 15 s<8e>ances par an et par individu suit une loi de Student <88> 20 degr<8e>s de libert<8e>, avec un <8e>cart type s = 20. Le nombre r<8e>el de fr<8e>quentations (<88> un seuil de confiance de 95%) oscilera autour de 15 avec + ou - : {#9.10389:0.01}
//qt(.975,20)*20/sqrt(21) 



Dans le cadre d'une <8e>tude de notori<8e>t<8e>, 25 % des personnes interrog<8e>es ont d<8e>clar<8e> conna<94>tre la marque M. Un <8e>chantillon al<8e>atoire non exhaustif de 1000 individus a <8e>t<8e> utilis<8e>. Dans une approche pessimiste la vraie proportion (<88> un seuil de confiance de 95%) oscilera autour de 25% avec + ou - : {#0.01581139:001}
// n=1000;sqrt((0.5*(1-0.5))/n)

Dans le cadre d'une <8e>tude de notori<8e>t<8e>, 25 % des personnes interrog<8e>es ont d<8e>clar<8e> conna<94>tre la marque M. Un <8e>chantillon al<8e>atoire non exhaustif de 1000 individus a <8e>t<8e> utilis<8e>. Dans une approche optimiste la vraie proportion (<88> un seuil de confiance de 95%) oscilera autour de 25% avec + ou - : {#0.01369306:001}
// n=1000;p=.25;sqrt((p*(1-p))/n)


Dans le cadre d'une <8e>tude de notori<8e>t<8e>, 25 % des personnes interrog<8e>es ont d<8e>clar<8e> conna<94>tre la marque M. Un <8e>chantillon al<8e>atoire non exhaustif de 1000 individus a <8e>t<8e> utilis<8e>. Quelle est la diff<8e>rence de pr<8e>cision entre l'approche pessimiste et optimiste (<88> un seuil de confiance de 95%) de cette estimation: {#0.002118324:0001}
// n=1000;p=.25;sqrt(0.5*(1-0.5)/n)-sqrt((p*(1-p))/n)

Le seuil de rentabilit<8e> d'un produit industriel nouveau s'<8e>l<8f>ve <88> 50 unit<8e>s vendues par consomateur. Sur un <8e>chantillon de 100 consommateurs, une intention d'achat moyenne de 62 a <8e>t<8e> rep<8e>r<8e>e, avec un <8e>cart-type de 60.Quel type de test d'hypoth<8f>se est applicables ici:{~unilat<8e>ral gauche, ~bilat<8e>ral, =unilat<8e>ral droit}

Le seuil de rentabilit<8e> d'un produit industriel nouveau s'<8e>l<8f>ve <88> 50 unit<8e>s vendues par consomateur. Sur un <8e>chantillon de 100 consommateurs, une intention d'achat moyenne de 62 a <8e>t<8e> rep<8e>r<8e>e, avec un <8e>cart-type de 60. Est-ce que le risque de tomber en desous du seuil de rentabilit<8e> peut <90>tre rejet<8e> avec un seuil de risque de 2.5% ?{=Oui,~non}
//n=100;xs=50;xm=62;s=60;(xm - xs)/s*sqrt(n) > qnorm(.975, 0,1)

Le seuil de rentabilit<8e> d'un produit industriel nouveau s'<8e>l<8f>ve <88> 50 unit<8e>s vendues par consomateur. Sur un <8e>chantillon de 100 consommateurs, une intention d'achat moyenne de 62 a <8e>t<8e> rep<8e>r<8e>e, avec un <8e>cart-type de 60. Est-ce que le risque de tomber en desous du seuil de rentabilit<8e> peut <90>tre rejet<8e> avec un seuil de risque de 5% ?{=Oui,~non}
//xs=50;xm=62;s=60;(xm - xs)/s*sqrt(n) > qnorm(.95, 0,1)

Le seuil de rentabilit<8e> d'un produit industriel nouveau s'<8e>l<8f>ve <88> 50 unit<8e>s vendues par consomateur. Sur un <8e>chantillon de 100 consommateurs, une intention d'achat moyenne de 62 a <8e>t<8e> rep<8e>r<8e>e, avec un <8e>cart-type de 60. Quel est le risque de se trouver sous le seuil de rentabilit<8e> (avec une pr<8e>cision de 0.001) ? {#0.02275013:0.001}
//n=100;xs=50;xm=62;s=60;1-pnorm((xm - xs)/s*sqrt(n))


Le seuil de rentabilit<8e> d'un produit industriel nouveau s'<8e>l<8f>ve <88> 50 unit<8e>s vendues par consomateur. Sur un <8e>chantillon de 100 consommateurs, une intention d'achat moyenne de 56 a <8e>t<8e> rep<8e>r<8e>e, avec un <8e>cart-type de 60.Quel type de test d'hypoth<8f>se est applicables ici:{~unilat<8e>ral gauche, ~bilat<8e>ral, =unilat<8e>ral droit}

Le seuil de rentabilit<8e> d'un produit industriel nouveau s'<8e>l<8f>ve <88> 50 unit<8e>s vendues par consomateur. Sur un <8e>chantillon de 100 consommateurs, une intention d'achat moyenne de 56 a <8e>t<8e> rep<8e>r<8e>e, avec un <8e>cart-type de 60. Est-ce que le risque de tomber en desous du seuil de rentabilit<8e> peut <90>tre rejet<8e> avec un seuil de risque de 2.5% ?{~Oui,=Non}
//n=100;xs=50;xm=56;s=60;(xm - xs)/s*sqrt(n) > qnorm(.975, 0,1)

Le seuil de rentabilit<8e> d'un produit industriel nouveau s'<8e>l<8f>ve <88> 50 unit<8e>s vendues par consomateur. Sur un <8e>chantillon de 100 consommateurs, une intention d'achat moyenne de 56 a <8e>t<8e> rep<8e>r<8e>e, avec un <8e>cart-type de 60. Est-ce que le risque de tomber en desous du seuil de rentabilit<8e> peut <90>tre rejet<8e> avec un seuil de risque de 5% ?{~Oui,=Non}
//n=100;xs=50;xm=56;s=60;(xm - xs)/s*sqrt(n) > qnorm(.95, 0,1)

Le seuil de rentabilit<8e> d'un produit industriel nouveau s'<8e>l<8f>ve <88> 50 unit<8e>s vendues par consomateur. Sur un <8e>chantillon de 100 consommateurs, une intention d'achat moyenne de 56 a <8e>t<8e> rep<8e>r<8e>e, avec un <8e>cart-type de 60. Quel est le risque de se trouver sous le seuil de rentabilit<8e> (pr<8e>cision 0.001)? {#0.1586553:0.001}
//n=100;xs=50;xm=56;s=60;1-pnorm((xm - xs)/s*sqrt(n))

Le taux de notori<8e>t<8e> de la marque M mesur<8e> sur un <8e>chantillon de 1000 consommateurs <88> la suite d'une campagne publicitaire <8e>tait de 25%. Le taux de notori<8e>t<8e> pr<8e>c<8e>demment connu s'<8e>levait <88> 21%. Peut-on en conclure que la publicit<8e> a fait augmenter de façon significative la connaissance de la marque ? {=Oui,~Non}
//n=1000;ps=0.21;p=0.25;(p-ps)/sqrt(.5*(1-.5)/n) > qnorm(.975)

Le taux de notori<8e>t<8e> de la marque M mesur<8e> sur un <8e>chantillon de 1000 consommateurs <88> la suite d'une campagne publicitaire <8e>tait de 25%. Le taux de notori<8e>t<8e> pr<8e>c<8e>demment connu s'<8e>levait <88> 21%. Quel est le risque que la campagne n'ait pas eu d'effet sur la notori<8e>t<8e>? (pr<8e>cision 0.0001){#0.005706018:0.001}
...
Calculez l'intervalle de confiance positif (alternative pessimiste) de la proportion des gens qui sont d'accord avec l'affirmation: CAMIP vend une ligne de produits de haute qualit<8e>' {#0.0880066:0.001} 
...
Calculez l'intervalle de confiance positif (alternative pessimiste) de la proportion des gens qui sont d'accord avec l'affirmation: CAMIP a un catalogue de tr<8f>s haute qualit<8e>' {#0.0880066:0.001} 
//x=V18[which(V18!=0)];n=length(x);1.96*sqrt(.5*(1-.5)/n)

Calculez l'intervalle de confiance positif (alternative pessimiste) de la proportion des gens qui sont d'accord avec l'affirmation: La description des produits dans le catalogue CAMIP est tr<8f>s pr<8e>cise' {#0.0880066:0.001} 
//x=V19[which(V19!=0)];n=length(x);1.96*sqrt(.5*(1-.5)/n)

Calculez l'intervalle de confiance positif (alternative pessimiste) de la proportion des gens qui sont d'accord avec l'affirmation: La s<8e>lection de produits dans le catalogue CAMIP est tr<8f>s large' {#0.0880066:0.001} 
//x=V20[which(V20!=0)];n=length(x);1.96*sqrt(.5*(1-.5)/n)

Calculez l'intervalle de confiance positif (alternative pessimiste) de la proportion des gens qui sont d'accord avec l'affirmation: "Probabilit<8e> r<8e>duite que la marchandise soie perdue pendant l'envoie" {#0.09099072:0.001} 
//x=V21[which(V21!=0)];n=length(x);1.96*sqrt(.5*(1-.5)/n)

Calculez l'intervalle de confiance positif (alternative pessimiste) de la proportion des gens qui sont d'accord avec l'affirmation: "Pas besoin de ce consulter avec quelqu'un qui a d<8e>j<88> achet<8e>" {#0.09021631:0.001} 
...
Calculez l'intervalle de confiance positif (alternative pessimiste) de la proportion des gens qui sont d'accord avec l'affirmation: "L'achat par catalogue <8e>conomise du temps" {#0.08836362:0.001} 
//x=V24[which(V24!=0)];n=length(x);1.96*sqrt(.5*(1-.5)/n)

Calculez l'intervalle de confiance positif (alternative pessimiste) de la proportion des gens qui sont d'accord avec l'affirmation: Pas difficile de n<8e>gocier le prix' {#0.08836362:0.001} 
...
Calculez l'intervalle de confiance positif (alternative pessimiste) de la proportion des gens qui donnent de l'importance <88>: Possibilit<8e> de placer un nombre illimit<8e> de commandes' {#0.08983645:0.001} 
//x=V30[which(V30!=0)];n=length(x);1.96*sqrt(.5*(1-.5)/n)

Calculez l'intervalle de confiance positif (alternative pessimiste) de la proportion des gens qui donnent de l'importance <88>: Disponibilit<8e> de discounts pour la quantit<8e> achet<8e>e' {#0.09301748:0.001} 
//x=V31[which(V31!=0)];n=length(x);1.96*sqrt(.5*(1-.5)/n)

Calculez l'intervalle de confiance positif (alternative pessimiste) de la proportion des gens qui donnent de l'importance <88>: Dur<8e>e de la livraison' {#0.09021631:0.001} 
//x=V32[which(V32!=0)];n=length(x);1.96*sqrt(.5*(1-.5)/n)

Calculez l'intervalle de confiance positif (alternative pessimiste) de la proportion des gens qui donnent de l'importance <88>: Politique de la soci<8e>t<8e> visant le retour de la marchandise' {#0.09386698:0.001} 
//x=V33[which(V33!=0)];n=length(x);1.96*sqrt(.5*(1-.5)/n)

Calculez l'intervalle de confiance positif (alternative pessimiste) de la proportion des gens qui donnent de l'importance <88>: "Pr<8e>vision d'une p<8e>riode d'essai" {#0.08946135:0.001} 
//x=V34[which(V34!=0)];n=length(x);1.96*sqrt(.5*(1-.5)/n)

Calculez l'intervalle de confiance positif (alternative pessimiste) de la proportion des gens qui donnent de l'importance <88>: Ann<8e>es de pr<8e>sence de la soci<8e>t<8e> sur le marche' {#0.0926013:0.001} 
//x=V35[which(V35!=0)];n=length(x);1.96*sqrt(.5*(1-.5)/n)

Calculez l'intervalle de confiance positif (alternative pessimiste) de la proportion des gens qui donnent de l'importance <88>: R<8e>putation de la soci<8e>t<8e>' {#0.08983645:0.001} 
//x=V36[which(V36!=0)];n=length(x);1.96*sqrt(.5*(1-.5)/n)

Calculez l'intervalle de confiance positif (alternative pessimiste) de la proportion des gens qui donnent de l'importance <88>: Garanties' {#0.09301748:0.001} 
//x=V37[which(V37!=0)];n=length(x);1.96*sqrt(.5*(1-.5)/n)

Calculez l'intervalle de confiance positif (alternative pessimiste) de la proportion des gens qui donnent de l'importance <88>: Contacte de la soci<8e>t<8e> avec les grandes marques etc.' {#0.09138547:0.001} 
...
Calculez l'intervalle de confiance positif (alternative optimiste) de la proportion des gens qui sont d'accord avec l'affirmation: CAMIP vend une ligne de produits de haute qualit<8e>' {#0.08573358:0.001} 
...
Calculez l'intervalle de confiance positif (alternative optimiste) de la proportion des gens qui sont d'accord avec l'affirmation: CAMIP a un catalogue de tr<8f>s haute qualit<8e>' {#0.08744388:0.001} 
//x=V18[which(V18!=0)];n=length(x);n2=length(x[x>3]);p=n2/n;1.96*sqrt(p*(1-p)/n)

Calculez l'intervalle de confiance positif (alternative optimiste) de la proportion des gens qui sont d'accord avec l'affirmation: La description des produits dans le catalogue CAMIP est tr<8f>s pr<8e>cise' {#0.08771995:0.001} 
//x=V19[which(V19!=0)];n=length(x);n2=length(x[x>3]);p=n2/n;1.96*sqrt(p*(1-p)/n)

Calculez l'intervalle de confiance positif (alternative optimiste) de la proportion des gens qui sont d'accord avec l'affirmation: La s<8e>lection de produits dans le catalogue CAMIP est tr<8f>s large' {#0.08707443:0.001} 
//x=V20[which(V20!=0)];n=length(x);n2=length(x[x>3]);p=n2/n;1.96*sqrt(p*(1-p)/n)

Calculez l'intervalle de confiance positif (alternative optimiste) de la proportion des gens qui sont d'accord avec l'affirmation: "Probabilit<8e> r<8e>duite que la marchandise soie perdue pendant l'envoie" {#0.08988858:0.001} 
//x=V21[which(V21!=0)];n=length(x);n2=length(x[x>3]);p=n2/n;1.96*sqrt(p*(1-p)/n)

Calculez l'intervalle de confiance positif (alternative optimiste) de la proportion des gens qui sont d'accord avec l'affirmation: "Pas besoin de ce consulter avec quelqu'un qui a d<8e>j<88> achet<8e>" {#0.08891103:0.001} 
...
Calculez l'intervalle de confiance positif (alternative optimiste) de la proportion des gens qui sont d'accord avec l'affirmation: "L'achat par catalogue <8e>conomise du temps" {#0.07111831:0.001} 
//x=V24[which(V24!=0)];n=length(x);n2=length(x[x>3]);p=n2/n;1.96*sqrt(p*(1-p)/n)

Calculez l'intervalle de confiance positif (alternative optimiste) de la proportion des gens qui sont d'accord avec l'affirmation: Pas difficile de n<8e>gocier le prix' {#0.08104916:0.001} 
...
Calculez l'intervalle de confiance positif (alternative optimiste) de la proportion des gens qui donnent de l'importance <88>: Possibilit<8e> de placer un nombre illimit<8e> de commandes' {#0.0896809:0.001} 
//x=V30[which(V30!=0)];n=length(x);n2=length(x[x>3]);p=n2/n;1.96*sqrt(p*(1-p)/n)

Calculez l'intervalle de confiance positif (alternative optimiste) de la proportion des gens qui donnent de l'importance <88>: Disponibilit<8e> de discounts pour la quantit<8e> achet<8e>e' {#0.08827238:0.001} 
//x=V31[which(V31!=0)];n=length(x);n2=length(x[x>3]);p=n2/n;1.96*sqrt(p*(1-p)/n)

Calculez l'intervalle de confiance positif (alternative optimiste) de la proportion des gens qui donnent de l'importance <88>: Dur<8e>e de la livraison' {#0.08891103:0.001} 
//x=V32[which(V32!=0)];n=length(x);n2=length(x[x>3]);p=n2/n;1.96*sqrt(p*(1-p)/n)

Calculez l'intervalle de confiance positif (alternative optimiste) de la proportion des gens qui donnent de l'importance <88>: Politique de la soci<8e>t<8e> visant le retour de la marchandise' {#0.07892707:0.001} 
//x=V33[which(V33!=0)];n=length(x);n2=length(x[x>3]);p=n2/n;1.96*sqrt(p*(1-p)/n)

Calculez l'intervalle de confiance positif (alternative optimiste) de la proportion des gens qui donnent de l'importance <88>: "Pr<8e>vision d'une p<8e>riode d'essai" {#0.08132568:0.001} 
//x=V34[which(V34!=0)];n=length(x);n2=length(x[x>3]);p=n2/n;1.96*sqrt(p*(1-p)/n)

Calculez l'intervalle de confiance positif (alternative optimiste) de la proportion des gens qui donnent de l'importance <88>: Ann<8e>es de pr<8e>sence de la soci<8e>t<8e> sur le marche' {#0.08443054:0.001} 
//x=V35[which(V35!=0)];n=length(x);n2=length(x[x>3]);p=n2/n;1.96*sqrt(p*(1-p)/n)

Calculez l'intervalle de confiance positif (alternative optimiste) de la proportion des gens qui donnent de l'importance <88>: R<8e>putation de la soci<8e>t<8e>' {#0.0896809:0.001} 
//x=V36[which(V36!=0)];n=length(x);n2=length(x[x>3]);p=n2/n;1.96*sqrt(p*(1-p)/n)

Calculez l'intervalle de confiance positif (alternative optimiste) de la proportion des gens qui donnent de l'importance <88>: Garanties' {#0.08643953:0.001} 
//x=V37[which(V37!=0)];n=length(x);n2=length(x[x>3]);p=n2/n;1.96*sqrt(p*(1-p)/n)

Calculez l'intervalle de confiance positif (alternative optimiste) de la proportion des gens qui donnent de l'importance <88>: Contacte de la soci<8e>t<8e> avec les grandes marques etc.' {#0.02389261:0.001} 
